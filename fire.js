...
function renderFire() {
    ...
    document.querySelector('#fireCanvas').innerHTML = html;//add the list generated in the 'let html' to the html

}//generates the html list wich will be used by the array
